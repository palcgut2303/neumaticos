...
public class Registrarse extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jBIniciarSesion.setForeground(new java.awt.Color(0, 0, 255));
        ...
        jBRegistrarse.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jBRegistrarse.setForeground(new java.awt.Color(255, 0, 0));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jTContraseña, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
    ...
    private void jBRegistrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBRegistrarseActionPerformed
        ...
        if (!jTUsuario.getText().equalsIgnoreCase("") && !jTContraseña.getText().equalsIgnoreCase("")) {
            String sinEncriptar = jTContraseña.getText();

            String contraseñaEncriptada = encriptar(sinEncriptar);

            if (bd.insertarUsuarios(jTUsuario.getText(), contraseñaEncriptada)) {

                JOptionPane.showMessageDialog(this, "Se ha agregado correctamente el usuario.");
                new Main().setVisible(true);
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "No se ha agregado correctamente el usuario.");
                setCampos();
            }
        } else {
    ...
    private String encriptar(String sinEncriptar) {
        String contraseñaEncriptada = DigestUtils.md5Hex(sinEncriptar);
    ...
    private void jBIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBIniciarSesionActionPerformed
        ...
        if (!jTUsuario.getText().equalsIgnoreCase("") && !jTContraseña.getText().equalsIgnoreCase("")) {
            ...
            if (bd.comprobarUsuario(jTUsuario.getText(), contraseñaEncriptada)) {

                JOptionPane.showMessageDialog(this, "Iniciando Sesion...");
                new Main().setVisible(true);
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Este usuario no existe o hay credenciales incorrectas");
                setCampos();
            }
        } else {
            JOptionPane.showMessageDialog(this, "RELLENA TODOS LOS CAMPOS");
